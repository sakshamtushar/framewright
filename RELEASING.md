...
```bash
security export -k ~/Library/Keychains/login.keychain-db -t identities -f pkcs12 -P "YOUR_P12_PASSWORD" -o framewright-mac-signing.p12
base64 < framewright-mac-signing.p12 | pbcopy
```
