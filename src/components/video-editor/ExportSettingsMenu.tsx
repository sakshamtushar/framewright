	...
	return (
		...
		>
						...
						return (
							<button
								...
								className={cn(
									...
									isActive
										? "border-[#E5AF89]/50 text-[#E5AF89] dark:text-white"
							...
							>
								{isActive ? (
									<motion.span
										...
										className="absolute inset-0 rounded-xl bg-[#E5AF89]/10"
			...
			{exportFormat === "mp4" ? (
				<LayoutGroup id="header-export-quality-toggle">
					...
					{!isLegacyModel && nvidiaCudaExportAvailable ? (
						<div className="mb-3 flex min-h-12 items-center justify-between gap-3 rounded-lg border border-[#E5AF89]/20 bg-[#E5AF89]/5 px-3 py-2">
							<div className="min-w-0">
								<div className="flex items-center gap-1.5">
									<span className="text-[11px] font-semibold text-foreground">
										{tSettings("export.nvidiaCuda.title", "NVIDIA CUDA")}
									</span>
									<span className="rounded bg-[#E5AF89]/10 px-1.5 py-0.5 text-[9px] font-semibold uppercase text-[#E5AF89]">
							...
							<Switch
								...
								className="shrink-0 scale-75 data-[state=checked]:bg-[#E5AF89]"
							/>
						</div>
					) : null}
					...
					<div className="flex items-center justify-between px-1">
						...
						<div className="flex items-center gap-2">
							...
							<Switch
								...
								className="scale-75 data-[state=checked]:bg-[#E5AF89]"
							/>
						</div>
					</div>
				</div>
			...
			<Button
				...
				size="lg"
				onClick={onExport}
				className="h-11 w-full gap-2 rounded-lg bg-[#E5AF89] text-sm font-semibold text-white transition-colors duration-200 hover:bg-[#E5AF89]/90"
			>
