import { ArrowRight, ArrowSquareOut as ExternalLink, Question as HelpCircle, Keyboard, ChatDots as MessageSquareMore, Scissors, GearSix as Settings2 } from "@phosphor-icons/react";
...
export const FRAMEWRIGHT_ISSUES_URL = "https://github.com/sakshamtushar/framewright/issues";
			...
			<DialogContent className="max-w-lg bg-editor-dialog border-foreground/10 [&>button]:text-muted-foreground [&>button:hover]:text-foreground">
				<DialogHeader>
					...
					<DialogDescription className="text-muted-foreground">
						{t("feedback.description", "Open an issue on GitHub if something is broken or missing.")}
					</DialogDescription>
				</DialogHeader>
				<div className="mt-4 space-y-4">
					<Button
						type="button"
						variant="outline"
						onClick={() => void openExternalLink(FRAMEWRIGHT_ISSUES_URL, t("feedback.openFailed", "Failed to open link."))}
